...
if spoon.WinWin then
    ...
    cmodal:bind('control', 'H', 'Top Third of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("topthird") end)
    cmodal:bind('control', 'M', 'Middle Third of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("middlethird") end)
    cmodal:bind('control', 'L', 'Bottom Third of Screen', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("bottomthird") end)
    ...
    cmodal:bind('', 'B', 'SouthWest Corner', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("cornerSW") end)
    cmodal:bind('', 'N', 'SouthEast Corner', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("cornerSE") end)
